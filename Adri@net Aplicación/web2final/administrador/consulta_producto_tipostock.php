...
$s="SELECT producto.nom_pro, producto.foto, producto.dec_pro ,inventario.stock_min,producto.precio_pro, producto.cant_pro, producto.id_pieza,inventario.stock_min
FROM producto, inventario 
WHERE producto.id_pieza = inventario.id_pieza and producto.cant_pro <= inventario.stock_min  ";

$d=mysql_query($s,$db)or die(mysql_error());
$x = mysql_num_rows($d);

if($x==0){ 

   echo "<p>No hay artículos por agotarse";
   echo "<hr>";
...
?>		
	  ...
	  <td><p align="center"><?php echo  $id_pieza;?> </p></td>
	  <td><p align="center"><?php echo substr($dec_pro, 0, 50)."...";?> </p></td>
	  <td><p align="center"><?php echo $cant_pro; ?> </p></td>
	  ...
	  <td><p align="center"><a href="cambiar_foto.php?id=<?php echo $s['id_pieza']?>">cambiar foto</a> </p></td>
	  	  <td><p align="center"><a href="modificar_producto.php?id=<?php echo $s['id_pieza']?>">modificar</a> </p></td>
	  <td><p align="center"><a href="eliminar_producto.php?id=<?php echo $s['id_pieza']?>">eliminar</a></p></td>
