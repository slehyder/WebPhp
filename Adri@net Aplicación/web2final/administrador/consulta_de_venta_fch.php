...
<FORM METHOD=POST ACTION="consulta_de_venta_fch.php" onsubmit="return comprobar()">
  <table  border="0">
    <tr>
      <td ><div align="right" ><span class="Estilo4">Rango de fechas:</span> <br />
          <span class="Estilo3">(el orden de la fecha debe ser de menor a mayor)</span> </div></td>
      <td >
...
$fecha_venta=$_REQUEST['y'];
 $fecha_venta2=$_REQUEST['y2'];
 	
if (($fecha_venta=="" and $fecha_venta2=="" ))  { ?>  
...
<script language="javascript">
 ...
 window.location="consulta_de_venta_fch.php";
 }  </script>
...
$sql="SELECT * FROM factura WHERE Fecha_venta  BETWEEN'".$_POST['y']."'  AND  '".$_POST['y2']."'";
