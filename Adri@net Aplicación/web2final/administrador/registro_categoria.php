...
<td valign="top" >
<br/>
      <form method="post" action="guarda_categoria.php" name="form1"   class='contacto1'  id="form1">
            ...
            <div><label>Indique codigo de la categoria:</label> </td><td><input name="id" type='text' size="26" id="id" value=''  onkeypress="return validarnum(event)" required="required"/>
            </div></td><td> 	<div align="left"  class="Estilo1">Ingrese un codigo numerico que identifique la categoria.</div></td>
			</tr>

			            <tr><td> <div><label>Nombre de la categoria:</label></td> <td><input name="nom" size="26" type='text' id="nom" value=''  required="required"/>
            </div>  </td><td><div align="left" class="Estilo1"> Ingrese el nombre de la categoria nueva </div> </td>
			            </tr> 
