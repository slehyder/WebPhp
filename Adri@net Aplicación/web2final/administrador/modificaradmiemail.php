...
function comprobar() {
         var mirarLargo="no";
         var mirarIgual="no";
         var contra1 = document.formu.email1
         var contra2 = document.formu.email2
		 var espacios = false;
         var cont = 0;
         ...
         if (contra1.value == contra2.value) {
		  ...
		  alert("El correo y su repetición deben ser iguales.");
          return false;
            }
...
?>	
     ...
     <form action="" method="post" id="formu" name="formu" onsubmit="return comprobar()">
  <table>
    <tr>
      <td>Modificacion de Datos</td>
	    ...
	    <tr>
      <td>Email nuevo:</td>
      <td><input name="email1" type="text"  required="required"   size="25"></td>
    </tr>
	    <tr>
      <td>Repita su nuevo email:</td>
      <td><input name="email2" type="text"  required="required"   size="25"></td>
    </tr>
      <td><div align="right">
