...
?>	
  ...
  <div class="CSSTableGenerator1" >
	    ...
	    <table >
	      ...
	      <tr>
	        <td>Email:</td>
	    <td><p align="center"><?php echo $s['email'] ?> </p></td>
		<td ><a href="modificaradmiemail.php"><strong>Modificar</strong></a></td>
	    </tr>
	  ...
	  <td ><a href="modificaradmipass.php"><strong>Modificar</strong></a></td>
	  </tr>
</table>
</div>
<div class="CSSTableGenerator1" >
...
<td>Datos Personales</td>
        ...
        <td><p align="center"><?php echo $s['nom_clie'] ?> </p></td>
	  </tr>
	      <tr>
	        <td> Telefono</td>
		    <td><p align="center"><?php echo $s['telf_clie'] ?> </p></td>
          </tr>
	      
	      <tr>
	        <td>Direcion</td>
           <td><p align="center"><?php echo $s['dire_clie'] ?> </p></td>
		    </tr>
	      <tr>
		  	      <tr>
	        <td>Numero de cuenta</td>
           <td><p align="center"><?php echo $s['num_deposit'] ?> </p></td>
		    </tr>
					  	      <tr>
	        <td>Tipo de cuenta</td>
           <td><p align="center"><?php echo $s['tipo_cuenta'] ?> </p></td>
		    </tr>

					  	      <tr>
	        <td>Banco</td>
           <td><p align="center"><?php echo $s['banco'] ?> </p></td>
		    </tr>
	      <tr>
	        <td ><a href="modificaradmi.php"><strong>Modificar Datos.</strong></a></td>
            </tr>
			</table>
			</div>
