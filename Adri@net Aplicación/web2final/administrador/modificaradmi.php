...
?>	
  ...
  <table>
    ...
    <tr>
      ...
      <td><input type="text" name="num_deposit"  onkeypress="return validarnum(event)" required="required" value="<?php echo $s["num_deposit"]?>"></td>
    </tr>
	<tr>
...
$tipo_cuenta=mysql_real_escape_string(strip_tags($_REQUEST['tipo_cuenta']));
$num_deposit=mysql_real_escape_string(strip_tags($_REQUEST['num_deposit']));
...
$banco=mysql_real_escape_string(strip_tags($_REQUEST['banco']));




		$a="UPDATE cliente SET nom_clie='".$nom."',dire_clie='".$dire."',telf_clie='".$tlf."' , num_deposit='".$num_deposit."' , tipo_cuenta='".$tipo_cuenta."' , banco='".$banco."' where cedula='".$cedula."'";
 		mysql_query($a, $db);
?>
