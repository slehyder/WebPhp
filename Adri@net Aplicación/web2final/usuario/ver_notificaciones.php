...
$sq="SELECT * FROM notificaciones WHERE (id_fact='$id_fac') and (tipo='baucher' or tipo='cancelado'  or tipo='vendido')";
...
?> <strong><span class="Estilo2">  <?php echo $nombre  ?> (admin)</span> Te ha enviado los datos para la realizacion del deposito<a href="consulta_de_inf_baucher.php?id_fact=<?php echo $id_fac ?>" style="text-decoration:none"  >Ver inf.</a> <br>
</strong>
<span class="Estilo1">Hecho el <?php echo $fecha ?> a las <?php echo $hora ?></span>  <br> 
<a href="enviar_numero_deposito.php?id_fact=<?php echo $id_fac ?>"  style="text-decoration:none" > Enviar numero de deposito realizado a esta compra </a>
<hr> 
...
?> <strong><span class="Estilo2">  <?php echo $nombre  ?> (admin)</span> Tu pedido ha sido procesado con exito<a href="consulta_de_inf_vendido.php?id_fact=<?php echo $id_fac ?>" style="text-decoration:none" target="_blank" >Ver inf.</a> <br>
</strong>
<span class="Estilo1">Hecho el <?php echo $fecha ?> a las <?php echo $hora ?></span>  <br> 
<hr> 
...
{
   echo "<p>No hay notificaciones recientes.";
   echo "<hr>";
}
?>
