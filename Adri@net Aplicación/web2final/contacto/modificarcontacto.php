...
?>	
  ...
  <table>
    ...
    <tr>
      <td>Telefonos</td>
      <td><input name="tlf" type="text"  size="32"  required="required" value="<?php echo $s["telefono"]?>"  ></td>
    </tr>

   <tr>
      <td>Rif</td>
      <td><input name="rif" type="text"  size="32"  required="required" value="<?php echo $s["rif"]?>"  ></td>
    </tr>


	    <tr>
      <td>Direccion</td>
      <td><textarea name="dire"   rows='6'><?php echo $s["contacto"]?> </textarea> </td>
    </tr>
    <tr>
      <td><div align="right">
...
$rif=$_REQUEST['rif'];
		...
		$a="UPDATE contacto SET telefono='".$tlf."',contacto='".$dire."' , rif='".$rif."' where id_contacto=1";
 		mysql_query($a, $db);
?>

 <SCRIPT LANGUAGE="JavaScript">
	alert("Sus datos han sido actualizados");
	 window.location="../contacto/contacto_admi.php";
 </SCRIPT>
 <?php
