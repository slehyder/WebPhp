...
<embed src="../imagenes/ingresa.jpg" quality="high" WIDTH="200" HEIGHT="25"></embed>


</div>
				
      <form method="post" action="control_ingreso.php" name="form" class='contacto' >
            <div>
              <label>Correo Electronico: </label>
              <input name="email" type="email" id="email" value=''  required="required" size="23"/>
            </div>
        <div>
              <label>Contrase&ntilde;a: </label>
              <input name="password" type="password" id="password" value='' size="23"  maxlength="16" required="required" />
			  
			  
        </div>
<div><input type="submit" value="Ingresar" /> </div>
<label><a href="../rcp/recp2.php" >Recuperar contrase&ntildea</a></label> </br>
  </form>
  </div>
 </td>
</tr>
